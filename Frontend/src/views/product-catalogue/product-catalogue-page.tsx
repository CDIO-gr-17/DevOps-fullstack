  ...
  export default function ProductCatalogPage() {
    const products = [
      ...
      },
      {
        id: 5,
        name: "Veiled Gaze",
        description: "This evocative sculpture, titled 'Veiled Gaze', portrays a woman with closed eyes in a contemporary, minimalist style. Created by the visionary artist Mira Castell in 2002, it draws inspiration from the myth of Medusa, yet reinterprets her with a serene, introspective expression. Castell’s intent was to explore themes of inner strength and vulnerability, capturing a moment of peaceful introspection amidst the chaos of modern life.",
        ...
        <Accordion type="multiple">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {products.map((product) => (
              <AccordionItem key={product.id} value={product.name} className="border-none">
                  <ProductCard
